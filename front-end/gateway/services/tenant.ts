...
type TenantDetailsRequest = ReturnType<
	typeof authenticatedRequest<TenantDetailsDto>
>;
...
export class TenantService {
	...
	private readonly tenantDetailsInFlight = new Map<
		string,
	...
	async findMultiple(params: paramsFindMultiple) {
		...
		return authenticatedRequest<TenantListItemDto[]>(
	...
	async findDetails(id: string) {
		...
		const request = authenticatedRequest<TenantDetailsDto>(
