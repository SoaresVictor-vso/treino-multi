					...
					<div className="border-b border-outline-variant bg-[radial-gradient(circle_at_top_left,rgba(195,244,0,0.18),transparent_26%),linear-gradient(180deg,rgba(255,255,255,0.04),transparent)] px-6 py-6 sm:px-8">
						<div className="mb-6 flex items-start justify-between gap-4">
							<div>
								...
								<h3
									id="modal-title"
									className="mt-2 text-2xl font-bold tracking-[-0.02em] text-primary sm:text-3xl"
								>
									{title}
								</h3>
								{description && (
									<p
										...
										className="mt-2 max-w-2xl text-sm leading-6 text-on-surface-variant sm:text-base"
									>
										{description}
									</p>
								)}
