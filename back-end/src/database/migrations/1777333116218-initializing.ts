...
export class Initializing1777333116218 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE TABLE "user_roles" ("user_id" uuid NOT NULL, "role" character varying NOT NULL, "assigned_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_09d115a69b6014d324d592f9c42" PRIMARY KEY ("user_id", "role"))`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "log_context_types" ("id" smallint NOT NULL, "name" character varying NOT NULL, CONSTRAINT "UQ_3609bc07724b8bb42d606c85a84" UNIQUE ("name"), CONSTRAINT "PK_3f510698cfb406217813fe64ff1" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
			`INSERT INTO "log_context_types" ("id", "name") VALUES (1, 'organization'), (2, 'tenant'), (3, 'standalone')`,
		);
		await queryRunner.query(
			`CREATE TABLE "authentication_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenant_id" uuid, "context_type_id" smallint NOT NULL, "success" boolean NOT NULL, "login_used" character varying NOT NULL, "ip_address" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_8f22c91bd5ae5f1f651f9ca5a1c" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
			`CREATE TABLE "critical_operation_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenant_id" uuid, "table_name" character varying NOT NULL, "operation" character varying NOT NULL, "record_id" character varying NOT NULL, "diff" jsonb, "user_id" uuid, "ip_address" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_67c5d17cf82a5ffb4a19328e625" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
			`CREATE TABLE "password_change_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenant_id" uuid, "user_id" uuid NOT NULL, "is_session" boolean NOT NULL, "ip_address" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6847e0a3d9a410c864ab4ec196b" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "users" ADD CONSTRAINT "FK_5ed72dcd00d6e5a88c6a6ba3d18" FOREIGN KEY ("person_id") REFERENCES "persons"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "authentication_logs" ADD CONSTRAINT "FK_8ced238bdc15b8bf4e99357e0e7" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "authentication_logs" ADD CONSTRAINT "FK_493d8572812d5e81a7a70438fb5" FOREIGN KEY ("context_type_id") REFERENCES "log_context_types"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "critical_operation_logs" ADD CONSTRAINT "FK_6cf1190bcf81d553399fa85dacc" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "critical_operation_logs" ADD CONSTRAINT "FK_9edd5e1ce4dc088151e14e11575" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "password_change_logs" ADD CONSTRAINT "FK_9afdc8e6564e1d43858acd0df07" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "password_change_logs" ADD CONSTRAINT "FK_42090dbd3b81794e58eb667cd40" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
		);
	}

	public async down(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`ALTER TABLE "password_change_logs" DROP CONSTRAINT "FK_42090dbd3b81794e58eb667cd40"`,
		);
		await queryRunner.query(
			`ALTER TABLE "password_change_logs" DROP CONSTRAINT "FK_9afdc8e6564e1d43858acd0df07"`,
		);
		await queryRunner.query(
			`ALTER TABLE "critical_operation_logs" DROP CONSTRAINT "FK_9edd5e1ce4dc088151e14e11575"`,
		);
		await queryRunner.query(
			`ALTER TABLE "critical_operation_logs" DROP CONSTRAINT "FK_6cf1190bcf81d553399fa85dacc"`,
		);
		await queryRunner.query(
			`ALTER TABLE "authentication_logs" DROP CONSTRAINT "FK_493d8572812d5e81a7a70438fb5"`,
		);
		await queryRunner.query(
			`ALTER TABLE "authentication_logs" DROP CONSTRAINT "FK_8ced238bdc15b8bf4e99357e0e7"`,
		);
		await queryRunner.query(
