...
export class CreateWorkoutDomain1780185600000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "exercises" ("id" SERIAL NOT NULL, "name" character varying(50) NOT NULL, "metric_1_id" integer NOT NULL, "metric_2_id" integer, "visual_url" character varying(100), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_exercises" PRIMARY KEY ("id"))`);
    await queryRunner.query(`INSERT INTO "exercises" ("name", "metric_1_id", "metric_2_id", "visual_url") SELECT seed."name", metric_1."id", metric_2."id", NULL FROM (VALUES ('Agachamento', 'reps', 'kg'), ('Supino', 'reps', 'kg'), ('Levantamento Terra', 'reps', 'kg'), ('Corrida', 'm', 's')) AS seed("name", "metric_1_symbol", "metric_2_symbol") INNER JOIN "metrics" metric_1 ON metric_1."symbol" = seed."metric_1_symbol" INNER JOIN "metrics" metric_2 ON metric_2."symbol" = seed."metric_2_symbol")`);
    await queryRunner.query(`CREATE TABLE "workout_templates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenant_id" uuid NOT NULL, "created_by" uuid NOT NULL, "updated_by" uuid NOT NULL, "name" character varying NOT NULL, "description" text NOT NULL DEFAULT '', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_workout_templates" PRIMARY KEY ("id"))`);
