...
export class CreateMeasurements1786400000000 implements MigrationInterface {
	...
	async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(`CREATE TABLE "measurements" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "key" varchar(80) NOT NULL, "name" varchar(120) NOT NULL, "active" boolean NOT NULL DEFAULT true, "metric_1_id" integer, "metric_2_id" integer, "formula" text NOT NULL, "value_formula" text NOT NULL, "static_weight" numeric NOT NULL DEFAULT 0, "dynamic_weight" numeric NOT NULL DEFAULT 0, "icon" varchar(40) NOT NULL, "presentation" jsonb NOT NULL DEFAULT '{}'::jsonb, CONSTRAINT "PK_measurements" PRIMARY KEY ("id"), CONSTRAINT "UQ_measurements_key" UNIQUE ("key"))`);
		...
		await queryRunner.query(`CREATE TABLE "workout_measurements" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "workout_id" uuid NOT NULL, "measurement_id" uuid NOT NULL, "value" numeric NOT NULL, "score" numeric NOT NULL, "snapshot" jsonb NOT NULL, CONSTRAINT "PK_workout_measurements" PRIMARY KEY ("id"), CONSTRAINT "UQ_workout_measurements_workout_measurement" UNIQUE ("workout_id", "measurement_id"))`);
